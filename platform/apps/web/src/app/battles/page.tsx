          ...
          <div className="p-6 rounded-2xl glass h-fit">
            ...
            {selected.status === 'producing' ? (
              <div className="text-center py-8">
                <Film size={40} className="text-otr-purple mx-auto mb-3 animate-pulse" />
              ...
              <>
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-gold-gradient text-otr-void font-semibold text-sm hover:opacity-90 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                >
